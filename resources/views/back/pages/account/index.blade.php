                            ...
                            <form action="{{ route('admin.account.update',$accounts) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per SMS Rate"
                                               name="sms_rate" id="sms_rate" value="{{ $accounts->sms_rate }}" step="0.00001" min="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" placeholder="Per SMS Rate"
                                               name="sms_allowed" id="sms_allowed" value="{{ $accounts->sms_allowed }}"  step="1" min="1" required>
                                    </div>
                                </div>
