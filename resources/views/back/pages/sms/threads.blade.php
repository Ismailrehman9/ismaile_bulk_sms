                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped table-bordered" id="datatable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.sms.show',$sms) }}" class="btn btn-outline-warning btn-sm" title="Reply" ><i class="fas fa-reply"></i></a>
                                                    <button data-toggle="modal" data-target="#saveModal" class="btn btn-outline-success btn-sm" title="Change Lead Category" data-id="{{ $sms->id }}" ><i class="fas fa-save"></i></button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
