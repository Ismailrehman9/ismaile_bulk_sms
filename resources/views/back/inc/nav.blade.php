        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                  ...
                  <li>  <a href="{{ route('admin.campaign.index') }}" ><i class="bx bx-home-circle"></i>
...
{{--                        <li><a href="{{ route('admin.bulksmscategory.index') }}">Bulk SMS By Category</a></li>--}}
                        ...
                        <li><a href="{{ route('admin.sms.failed') }}">Failed SMS</a></li>
                         ...
                         <li><a href="{{ route('admin.template.index') }}" > <i class="fas fa-bars"></i>
                ...
                <li>
                    <a href="{{ route('admin.market.index') }}" class=" waves-effect">
                        <i class="fas fa-map"></i>
                        <span>Markets</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.rvm.index') }}" class=" waves-effect">
                        <i class="fa fa-tag"></i>
                        <span>RVMS</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.number.index') }}" class=" waves-effect">
                        <i class="fas fa-mobile-alt"></i>
                        <span>Phone Numbers</span>
                    </a>
                </li>
                <li><a href="{{ route('admin.quick-response.index') }}" class=" waves-effect"><i class="fas fa-reply"></i>
